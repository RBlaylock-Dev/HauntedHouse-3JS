...
const floorNormalTexture = textureLoader.load('./floor/coast_sand_rocks_02_1k/coast_sand_rocks_02_nrm_1k.webp')
...
floorColorTexture.colorSpace = THREE.SRGBColorSpace // use sRGB color space for color  textures only
...
const floor = new THREE.Mesh(
    ...
    new THREE.MeshStandardMaterial({ alphaMap: floorAlphaTexture,
        transparent: true,
...
const door = new THREE.Mesh(
    ...
    new THREE.MeshStandardMaterial({
        ...
        roughtnessMap: doorRoughnessTexture
    })
)
door.position.y = 1
...
const graveGeometry = new THREE.BoxGeometry(0.8, 0.8, 0.2)
